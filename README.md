...
3. Submit: Remember that all members of your team should attempt each part of the assignment and push your individual work to Github. *You may work together* and share code and ideas. However, *only each person should submit their own solution* (see submission details [here](https://github.com/ISS-Security/hw_3-credit_card_crypto#submission)).
